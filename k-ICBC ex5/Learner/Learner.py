...
class Learner():
    ...
    def train(self, lr = 0.001, flag = False):
        ...
        while not eye:
            ...
            tr_set_X_init, tr_set_X_unsafe, tr_set_X = self.sampling_dataset.fullBatch()
            ...
            LogHandler.info_log(n_epochs, totalLoss, totalLoss1, totalLoss2, totalLoss3)
            if totalLoss == 0.:
                break
