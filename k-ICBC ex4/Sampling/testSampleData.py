...
#ax.scatter(data_Xi.iloc[:, 0], data_Xi.iloc[:, 1], data_Xi.iloc[:, 2],alpha=0.5, marker = 'o')
#ax.scatter(data_Xu.iloc[:, 0], data_Xu.iloc[:, 1], data_Xu.iloc[:, 2], alpha=0.01, marker = 'o')
#ax.scatter(data_X.iloc[:, 0], data_X.iloc[:, 1], data_X.iloc[:, 2], alpha=0.01, marker = 'o')
