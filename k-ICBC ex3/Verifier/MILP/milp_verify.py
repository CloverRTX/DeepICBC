...
def MILP_theNextPoint(m, x_pre, x_next, Col):
    ...
    sin_x_pre_0 = m.addVar(vtype=GRB.CONTINUOUS, lb=-1, ub=1)
    cos_x_pre_0 = m.addVar(vtype=GRB.CONTINUOUS, lb=-1, ub=1)
    tan_x_pre_2 = m.addVar(vtype=GRB.CONTINUOUS, lb=-np.inf, ub=np.inf)
    cos_x_pre_2 = m.addVar(vtype=GRB.CONTINUOUS, lb=-1, ub=1)
    cos_x_pre_2_pow2 = m.addVar(vtype=GRB.CONTINUOUS, lb=0, ub=1)

    m.addGenConstrSin(x_pre[0], sin_x_pre_0)
    m.addGenConstrCos(x_pre[0], cos_x_pre_0)
    m.addGenConstrTan(x_pre[2], tan_x_pre_2)
    m.addGenConstrCos(x_pre[2], cos_x_pre_2)
    # m.addGenConstrPow(cos_x_pre_2, cos_x_pre_2_pow2, 2)
    m.addConstr(cos_x_pre_2_pow2 == cos_x_pre_2 * cos_x_pre_2)
    ...
    m.addConstr(x1_dot == 30 * sin_x_pre_0 + 15 * u * cos_x_pre_0)
    m.addConstr(x2_dot == u * cos_x_pre_2_pow2 - 20 * cos_x_pre_2_pow2 * tan_x_pre_2)
